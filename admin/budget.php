        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Budget Details
                                </li>
                            </ol>
                        </div>
                        <!-- /.col -->
           ...
           if (isset($_POST['submit'])) {
               ...
               if (empty($budget_name)) {
                   ...
                   $create_cat_query = "INSERT INTO  budget  (budget_name,edate) VALUES('$budget_name','$edate')";
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="">
                                        <div class="modal-body">
                                            ...
                                            <td>
                                                <div class="col-md-12">
                                                    <label for="vechile_name">Budget Name</label>
                                            ...
                                            <td>
                                                <div class=" col-md-12">
                                                    <label for="vechile_name">Date</label>
                                                    <input type="date" class="form-control" name="edate" value="" min="<?php
           ...
           $select_all_query = "SELECT * FROM budget";
           ...
           while ($row = mysqli_fetch_assoc($select_all_result)) {
              ...
              // $id = $row['id'];
               ...
               echo "  
                                                           ...
                                                           <a class='btn btn-info btn-sm'   href='bud_edit.php?edit={$budget_name}'>
                                                ...
                                                <a class='btn btn-danger btn-sm' href='budget.php?delete={$budget_name}'>
...
if (isset($_GET['delete'])) {
    ...
    $delete_query = "DELETE FROM budget  WHERE budget_name ='$delete_cat_id'";
