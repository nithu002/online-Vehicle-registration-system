               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="report_vehicle.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>By Vehicle</p>
                                    </a>
                                </li>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">By Vehicle</li>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="country">
                                                        ...
                                                        <select class="form-control"
                                                            ...
                                                            <?php
                                                                $select_all_category = "SELECT vehicle_name FROM  vehilce ";
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <a class='btn btn-danger' href='report_vehicle.php'>
                            ...
                            <div class="card">
                                ...
                                <div class="card mt-4">
                                    <div class="card-body">
                                      ...
                                      if(isset($_GET['from_date']) && isset($_GET['to_date'])&& isset($_GET['vehicle']))
                                                    {        
                                                         $from_date = $_GET['from_date'];
                                                         $to_date = $_GET['to_date'];
                                                         $rname=$_GET['vehicle'];

                                                         $query = "SELECT * FROM  full  WHERE  created_at  BETWEEN '$from_date'  AND '$to_date' ";
                                                          $query_run = mysqli_query($con, $query);

                                                         if(mysqli_num_rows($query_run) > 0)
                                                           { 
                                                                foreach($query_run as $row)
                                                                       { if($rname == $row['vehicle_name']){
                                                                    ?>
