               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="report_department.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>By Department</p>
                                    </a>
                                </li>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="country">
                                                        ...
                                                        <select class="form-control"
                                                            ...
                                                            <option value="">Choose that</option>
                                                            <?php
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <a class='btn btn-danger' href='report_department.php'>
                            ...
                            <div class="card">
                                ...
                                <div class="card mt-4">
                                    <div class="card-body">
                                      ...
                                      if(isset($_GET['from_date']) && isset($_GET['to_date'])&& isset($_GET['depart']))
                                                    {        
