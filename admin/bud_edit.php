...
<?php if (isset($_GET['edit'])) {
        ...
        $select_all_query = "SELECT * FROM budget WHERE budget_name ='$edit_cat_id'";
...
<?php
    if (isset($_POST['xupdate'])) {
       $id = $_POST['id'];
        ...
        $sql = "UPDATE budget SET  budget_name='$budget_name',edate='$edate' where id='$id'";
        ...
        if ($result) {
            ...
            header('Location:budget.php?edit=new');
        } else {
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Budget Edit panel</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="budget.php">Budget Details</a></li>
                                <li class="breadcrumb-item active">Budget Edit panel
                                </li>
                                    ...
                                    <tbody>
                                        <form method="POST">
                                            <tr>
                                                ...
                                                <td>
                                                    <a><input type="hidden" name="id" value="<?php echo $id ?>">

                                                        <input type="name" class="form-control" name="budget_name"
                                                            value="<?php echo $budget_name ?>" required
                                            ...
                                            date_default_timezone_set('Asia/Kolkata');
                                               $date = date('20y-m-d');
                                                ...
                                                <td class='project-actions text-right'>
                                                    <a href="budget.php?add="><button type="button"
